    ...
    return (
        <div className="space-y-6">
            ...
            <GlassPanel className="p-4">
                <StatusPipeline
                    stages={[
                        { id: "pending", label: "Pending", count: stats.pending, icon: Clock, color: "text-muted-foreground bg-muted/50" },
                        ...
                        { id: "out_for_delivery", label: "Out for Delivery", count: stats.outForDelivery, icon: MapPin, color: "text-primary bg-primary/10" },
                        { id: "delivered", label: "Delivered", count: stats.delivered, icon: CheckCircle, color: "text-success bg-success/10" },
