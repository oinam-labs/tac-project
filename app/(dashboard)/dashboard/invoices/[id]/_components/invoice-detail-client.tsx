...
const statusConfig: Record<InvoiceStatus, { label: string; bgColor: string; dotColor: string }> = {
  draft: { label: "Draft Protocol", bgColor: "bg-muted/10 text-muted-foreground border-muted", dotColor: "bg-muted-foreground" },
  pending: { label: "Awaiting Settlement", bgColor: "bg-warning/10 text-warning border-warning", dotColor: "bg-warning" },
  paid: { label: "Settlement Confirmed", bgColor: "bg-primary/10 text-primary border-primary", dotColor: "bg-primary" },
  partial: { label: "Partial Settlement", bgColor: "bg-primary/10 text-primary border-primary", dotColor: "bg-primary" },
  overdue: { label: "Overdue Alert", bgColor: "bg-destructive/10 text-destructive border-destructive", dotColor: "bg-destructive" },
  cancelled: { label: "Protocol Aborted", bgColor: "bg-muted/10 text-muted-foreground border-muted", dotColor: "bg-muted" },
};
    ...
    <div className="p-6 space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 rounded-[2.5rem] border-2 border-muted shadow-sm relative overflow-hidden">
        ...
        <div className="flex items-center gap-6 relative">
          <Button variant="ghost" size="icon" asChild className="h-12 w-12 rounded-2xl bg-muted/10 hover:bg-muted/10 transition-all border border-muted">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="p-2 hover:bg-muted/10 rounded-xl transition-all text-muted-foreground hover:text-primary border border-transparent hover:border-muted"
              >
                {copied ? (
        ...
        <TabsContent value="details" className="mt-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <SummaryCard
              ...
              color={invoice.balance_due > 0 ? "text-destructive" : "text-primary"}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="rounded-[2.5rem] border-2 border-muted shadow-sm overflow-hidden">
              <CardHeader className="bg-muted/10 border-b border-muted py-4 px-8">
            ...
            <Card className="rounded-[2.5rem] border-2 border-muted shadow-sm overflow-hidden">
              <CardHeader className="bg-primary/10 border-b border-primary py-4 px-8">
          ...
          {/* Charges Breakdown */}
          <Card className="rounded-[2.5rem] border-0 bg-background text-white shadow-2xl relative overflow-hidden">
