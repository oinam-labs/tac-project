...
export function InsightWidget() {
  return (
    <div className="from-primary via-primary/80 to-accent/90 group relative mt-auto flex h-[180px] flex-col justify-between overflow-hidden rounded-[32px] bg-gradient-to-br p-8 shadow-xl shadow-primary/30 text-primary-foreground">
      ...
      <div className="relative z-10">
        <div className="mb-3 flex items-center gap-2 self-start rounded border border-white/20 bg-black/10 px-2 py-1 text-xs font-medium text-primary-foreground/90 backdrop-blur-md">
