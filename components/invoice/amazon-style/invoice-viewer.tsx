            ...
            <Tabs defaultValue="invoice" className="w-full no-print">
                <div className="flex justify-center mb-8">
                    <TabsList className="bg-white p-1 rounded-full border shadow-sm">
                        <TabsTrigger value="invoice" className="rounded-full px-6 py-2 text-xs font-bold uppercase tracking-widest data-[state=active]:bg-foreground data-[state=active]:text-background">
                            Tax Invoice
                        </TabsTrigger>
                        <TabsTrigger value="label" className="rounded-full px-6 py-2 text-xs font-bold uppercase tracking-widest data-[state=active]:bg-foreground data-[state=active]:text-background">
                            AWB Label
                        </TabsTrigger>
                    </TabsList>
                </div>
