        ...
        <div className="min-h-screen bg-muted/50 p-6 space-y-6">
            ...
            <div className="flex items-center justify-between no-print mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-black tracking-tight text-foreground">
                            Invoice <span className="text-muted-foreground">#{data.invoiceId}</span>
                        </h1>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button onClick={handlePrint} className="gap-2 font-black shadow-lg shadow-primary/20">
                        Print Document
            ...
            <Tabs defaultValue="invoice" className="w-full no-print">
                <div className="flex justify-center mb-8">
                    <TabsList className="bg-white p-1 rounded-full border shadow-sm">
                        <TabsTrigger value="invoice" className="rounded-full px-6 py-2 text-xs font-bold uppercase tracking-widest data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
                            Tax Invoice
                        </TabsTrigger>
                        <TabsTrigger value="label" className="rounded-full px-6 py-2 text-xs font-bold uppercase tracking-widest data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
                            AWB Label
                        </TabsTrigger>
                    </TabsList>
                </div>
                ...
                <TabsContent value="invoice" className="flex justify-center pb-20">
                    <div className="shadow-2xl shadow-muted/50">
