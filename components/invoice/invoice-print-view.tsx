...
export function InvoicePrintView({
    ...
    return (
      ...
      `}</style>
            ...
            <div className="flex justify-between items-start border-b-2 border-black pb-4 mb-4">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        <h1 className="text-3xl font-bold tracking-tighter">TAC<span className="text-warning">.</span></h1>
            ...
            {/* Addresses */}
            <div className="grid grid-cols-2 gap-8 mb-6 border-b border-muted pb-4">
                <div>
                    <h3 className="font-bold text-xs uppercase text-muted-foreground mb-2">Shipped From (Consignor)</h3>
                    <div className="text-sm font-semibold">{consignor.name}</div>
                    <div className="text-xs mt-1 whitespace-pre-line text-foreground">
                ...
                <div>
                    <h3 className="font-bold text-xs uppercase text-muted-foreground mb-2">Shipped To (Consignee)</h3>
                ...
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody>
                        {packages.map((pkg, idx) => (
                            <tr key={idx} className="border-b border-muted zebra-row">
            ...
            <div className="flex justify-between items-end mt-auto pt-8">
                ...
                <div className="text-center">
                    <div className="h-12 w-32 border-b border-muted mb-1"></div>
