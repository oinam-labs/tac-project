    ...
    <div className={cn("bg-white", className)}>
      ...
      >
        ...
        <div className="border-b-2 border-black pb-2 mb-2">
          <div className="text-xs font-bold text-muted-foreground mb-1">Ship To:</div>
        ...
        <div className="grid grid-cols-3 gap-0 border-b-2 border-black mb-2">
          <div className="border-2 border-black p-1 text-center">
            <div className="text-[9px] text-muted-foreground uppercase">Delivery Station</div>
            <div className="font-bold text-xl">{data.destinationStation || "GAUA"}</div>
          </div>
          <div className="border-2 border-black p-1 text-center">
            <div className="text-[9px] text-muted-foreground uppercase">Sector</div>
            <div className="font-bold text-lg">{data.sector || "S-05"}</div>
          </div>
          <div className="border-2 border-black p-1 text-center">
            <div className="text-[9px] text-muted-foreground uppercase">Sortzone</div>
        ...
        <div className="text-[10px] border-b border-black pb-2 mb-2">
          ...
          <div className="text-[9px] leading-tight text-foreground">
