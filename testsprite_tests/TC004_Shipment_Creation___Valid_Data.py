...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'New Shipment' button to navigate to shipment creation page.
        frame = context.pages[-1]
        # Click on 'New Shipment' button on dashboard to open shipment creation form.
        elem = frame.locator('xpath=html/body/div[2]/main/main/div/div/div/div/div[2]/div/div[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Try alternative navigation by clicking 'New Shipment' link (index 45) in the sidebar or quick actions to open shipment creation page.
        frame = context.pages[-1]
        # Click on 'New Shipment' link in sidebar or quick actions to open shipment creation page.
        elem = frame.locator('xpath=html/body/div[2]/main/main/div/div/div[5]/div[2]/div/div[2]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        # -> Fill in consignee details with valid data and click 'Next' to proceed to Address step.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError("Test case failed: Shipment creation did not succeed as expected. The shipment was not created successfully or not visible in the shipment list.")
