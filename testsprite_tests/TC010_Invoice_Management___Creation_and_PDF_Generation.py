...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Sign In' to log in as admin to proceed with invoice creation.
        ...
        # -> Click Sign In button to attempt login again or navigate to dashboard if already logged in.
        frame = context.pages[-1]
        ...
        # -> Click on 'Shipments' tab to select a shipment for invoice creation.
        frame = context.pages[-1]
        # Click on 'Shipments' tab to view shipment details
        elem = frame.locator('xpath=html/body/div[2]/div/div[2]/div/div[2]/div[2]/ul/li/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Select a shipment from the list to open its details for invoice creation.
        frame = context.pages[-1]
        # Select shipment with reference SHP-IMF-2601-0005 for invoice creation
        ...
        try:
            ...
            raise AssertionError("Test case failed: Invoice creation, viewing, and PDF generation did not complete successfully as per the test plan.")
